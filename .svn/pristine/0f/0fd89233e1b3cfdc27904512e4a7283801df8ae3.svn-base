<template>
    <div class="amap-page-container">
	    <el-amap vid="vuemap1" :center="center" :plugin="plugin" :zoom="zoom" :events="events" style="width:100%;height:200px;">
	    </el-amap>
    </div>
  </template>
<style type="text/css">
      ...
      methods: {
		...
		markerDragend(marker){
			marker.on("dragend", (e,handler,context)=>{
		    	let lnglatXY = [e.lnglat.M,e.lnglat.O];
